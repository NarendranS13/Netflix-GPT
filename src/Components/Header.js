  ...
  return (
    <div className='absolute px-8 py-2 bg-gradient-to-b from-black z-20 w-full flex justify-between'>
      ...
      { user && <div className='flex p-2 justify-between'>
        <select className='m-2 p-2 bg-gray-900 text-white rounded-xl' onChange={handleLanguageChange}>
        ...
        <img 
            ...
            alt = 'user-icon'
        />
        <button onClick = {handleSignOut} className='py-0.5 rounded-lg mr-2 ml-2 font-semibold text-white hover:bg-red-700'>Sign Out</button>
      </div>}
